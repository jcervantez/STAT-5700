...
wsci %>%
  ...
  ggtitle("BS degrees granted across fields and sexes over time")

# TODO: above is a disaster ... I'll need to play with it
...
wsci %>%
  ...
  facet_grid(~Degree)+
  ggtitle("Female proportion in fields across year by degree")
```
