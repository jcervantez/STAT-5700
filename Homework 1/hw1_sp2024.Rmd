...
```{r question_4.1b, echo = TRUE, results = 'markup'}
...
```{r question_4.2a, echo = TRUE}
# Print table of top 5 teams with increase in payroll between 2010 and 2014
baseball_long |>
