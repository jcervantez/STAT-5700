...
After we ask these questions, we will calculating the proportion of Wharton listeners to total podcast listeners within the Prolific sample and applying this proportion to the known estimate of total 100 million podcast listeners to estimate the Wharton show's audience size. We use the total podcast estimate because the Wharton audience is influenced by various sources (e.g., Apple podcasts, Spotify, etc.), and not just a single source (e.g., SiriusXM.)
