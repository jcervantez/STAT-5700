...
```{r question_4.2a, results = 'markup', warnings=FALSE, message=FALSE}
...
```{r question_4.2b, results='markup', warnings=FALSE, message=FALSE}
...
```{r question_4.3, results='markup', warnings=FALSE, message=FALSE}
