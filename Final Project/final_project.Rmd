...
This report uses data in partnership with a large pharmacy in the United States. Since the data is subject to HIPAA privacy requirements, all the data for the analysis was conducted on a separate secure server, in accordance with the contractual obligations with the pharmacy partner. 
