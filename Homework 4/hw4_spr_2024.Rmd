...
data_train <- data2[1:13000,]
data_test <- data2[13001:18000,]
data_validate <- data2[18001:19999,]
...
wordcloud(neg_words[1:100], neg_coef_invert[1:100], colors = color_scheme, ordered.colors = F)
...
prob_logit <- predict(fit_logit, data_test_x, type = "response")
