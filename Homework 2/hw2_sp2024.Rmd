...
pacman::p_load(ISLR, tidyverse, data.table, Hmisc, corrplot, ggbiplot, factoextra, patchwork, cluster) # add the packages needed!!!
```
...
1. Summary and transformation
    ...
    * According to the scree plot, it would be best to use 2 PCs. The plot shows a clear elbow after the 2nd PC, and the proportion of variance explained looks significantly lower after the 2nd PC.
