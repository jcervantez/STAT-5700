...
pacman::p_load(ISLR, tidyverse, data.table, Hmisc, corrplot, ggbiplot, factoextra, patchwork, cluster, gridExtra, skimr, GGally) # add the packages needed!!!
```
...
auto <- auto |>
  mutate(
    ...
    year = as.factor(year), # set year as factor
...
Overall, it seems that American cars tend to be heavier, have more cylinders, and have higher displacement and horsepower, but lower `mpg` and acceleration. Japanese cars tend to be lighter, have fewer cylinders, and have lower displacement and horsepower, but higher `mpg` and acceleration. European cars tend to have similar characteristics to Japanese cars, but not to American cars.
