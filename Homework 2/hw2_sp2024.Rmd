...
# Step 1 & 2: Filter out genes with only zero counts and no variability
genes_to_keep <- brca %>% 
...
set.seed(124) 
kmeans_result <- kmeans(features, centers = 4)
...
discrepancy_table <- table(brca_with_clusters$BRCA_Subtype_PAM50, brca_subtype)

# View the discrepancy table
print(discrepancy_table)
```
